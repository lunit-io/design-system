...
<Canvas of={IconStories.Variant} sourceState="shown" />
...
- [Mui Icons](https://mui.com/components/icons/#svgicon)
- [Mui SvgIcon API](https://mui.com/material-ui/api/svg-icon/)
- [Icons Figma](https://www.figma.com/file/tlomwt8dT0GWikKqzYH7TO/Lunit_Icons_v1.1.0?node-id=12135%3A6066&mode=dev)
