...
- wrapper 가 중첩되었을 때 컬러 토큰은 바로 상위 부모 wrapper 의 컨텍스트를 따라감
    - ex)        
      ...
      <div class='light1'>
        <div class='dark1'>
          // Button 의 배경 색상은 바로 상위 부모인 dark1 테마를 따라 dark1 테마 색상
          <Button 
            sx={{
...
<del>- 피그마에서 컬러 토큰 확인 법</del>
<del>- 자동완성기능 예제 → vscode 에서 어떻게 보이는지</del>
<del>- core token 의 사용 예시를 좀 더 많이 보여주면 좋겠다</del>
...
<del>- global palette color 사용 예제</del>
<del>- mui 기본 팔레트 컬러 설정값에 대한 설명</del>
